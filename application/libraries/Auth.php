...
class Auth
{
    ...
    */
    ...
    public function showLoginForm($data = array())
    {
        ...
        return $this->CI->load->view("login", $viewData);
    }
    ...
    protected function validate($request)
    {
        ...
        if ($this->CI->form_validation->run() == TRUE) {
            ...
            $this->email = $this->CI->input->post("email", TRUE);
    ...
    {
        $this->error["failed"] = "Email atau Kata Sandi salah.";
    ...
    {
        $this->CI->session->unset_userdata(array("userID", "email", "loginStatus"));
